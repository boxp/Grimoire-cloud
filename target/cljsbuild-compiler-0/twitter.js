...
grimoire_cloud.twitter.User.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__2904__auto__,k6536,else__2905__auto__){
var self__ = this;
if((k6536 === "\uFDD0:id"))
{return self__.id;
} else
...
{if((k6536 === "\uFDD0:profile-img"))
{return self__.profile_img;
} else
{if((k6536 === "\uFDD0:tweet-count"))
...
{if("\uFDD0:else")
{return cljs.core.get.call(null,self__.__extmap,k6536,else__2905__auto__);
} else
{return null;
}
}
...
grimoire_cloud.twitter.User.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__2909__auto__,k__2910__auto__,G__6535){
var self__ = this;
var pred__6538 = cljs.core.identical_QMARK_;
var expr__6539 = k__2910__auto__;
if(pred__6538.call(null,"\uFDD0:id",expr__6539))
{return (new grimoire_cloud.twitter.User(G__6535,self__.name,self__.profile_img,self__.tweet_count,self__.disc,self__.__meta,self__.__extmap,null));
} else
{if(pred__6538.call(null,"\uFDD0:name",expr__6539))
{return (new grimoire_cloud.twitter.User(self__.id,G__6535,self__.profile_img,self__.tweet_count,self__.disc,self__.__meta,self__.__extmap,null));
} else
{if(pred__6538.call(null,"\uFDD0:profile-img",expr__6539))
{return (new grimoire_cloud.twitter.User(self__.id,self__.name,G__6535,self__.tweet_count,self__.disc,self__.__meta,self__.__extmap,null));
} else
{if(pred__6538.call(null,"\uFDD0:tweet-count",expr__6539))
{return (new grimoire_cloud.twitter.User(self__.id,self__.name,self__.profile_img,G__6535,self__.disc,self__.__meta,self__.__extmap,null));
} else
{if(pred__6538.call(null,"\uFDD0:disc",expr__6539))
{return (new grimoire_cloud.twitter.User(self__.id,self__.name,self__.profile_img,self__.tweet_count,G__6535,self__.__meta,self__.__extmap,null));
} else
{return (new grimoire_cloud.twitter.User(self__.id,self__.name,self__.profile_img,self__.tweet_count,self__.disc,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__2910__auto__,G__6535),null));
}
}
}
}
...
grimoire_cloud.twitter.User.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__2901__auto__,G__6535){
var self__ = this;
return (new grimoire_cloud.twitter.User(self__.id,self__.name,self__.profile_img,self__.tweet_count,self__.disc,G__6535,self__.__extmap,self__.__hash));
});
...
grimoire_cloud.twitter.map__GT_User = (function map__GT_User(G__6537){
return (new grimoire_cloud.twitter.User((new cljs.core.Keyword("\uFDD0:id")).call(null,G__6537),(new cljs.core.Keyword("\uFDD0:name")).call(null,G__6537),(new cljs.core.Keyword("\uFDD0:profile-img")).call(null,G__6537),(new cljs.core.Keyword("\uFDD0:tweet-count")).call(null,G__6537),(new cljs.core.Keyword("\uFDD0:disc")).call(null,G__6537),null,cljs.core.dissoc.call(null,G__6537,"\uFDD0:id","\uFDD0:name","\uFDD0:profile-img","\uFDD0:tweet-count","\uFDD0:disc")));
});
...
grimoire_cloud.twitter.Tweet.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__2904__auto__,k6542,else__2905__auto__){
var self__ = this;
if((k6542 === "\uFDD0:user"))
{return self__.user;
} else
...
{if("\uFDD0:else")
{return cljs.core.get.call(null,self__.__extmap,k6542,else__2905__auto__);
} else
{return null;
}
}
...
grimoire_cloud.twitter.Tweet.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__2909__auto__,k__2910__auto__,G__6541){
var self__ = this;
var pred__6544 = cljs.core.identical_QMARK_;
var expr__6545 = k__2910__auto__;
if(pred__6544.call(null,"\uFDD0:user",expr__6545))
{return (new grimoire_cloud.twitter.Tweet(G__6541,self__.faved_QMARK_,self__.reted_QMARK_,self__.isret_QMARK_,self__.id,self__.date,self__.txt,self__.mention_user,self__.source,self__.__meta,self__.__extmap,null));
} else
{if(pred__6544.call(null,"\uFDD0:faved?",expr__6545))
{return (new grimoire_cloud.twitter.Tweet(self__.user,G__6541,self__.reted_QMARK_,self__.isret_QMARK_,self__.id,self__.date,self__.txt,self__.mention_user,self__.source,self__.__meta,self__.__extmap,null));
} else
{if(pred__6544.call(null,"\uFDD0:reted?",expr__6545))
{return (new grimoire_cloud.twitter.Tweet(self__.user,self__.faved_QMARK_,G__6541,self__.isret_QMARK_,self__.id,self__.date,self__.txt,self__.mention_user,self__.source,self__.__meta,self__.__extmap,null));
} else
{if(pred__6544.call(null,"\uFDD0:isret?",expr__6545))
{return (new grimoire_cloud.twitter.Tweet(self__.user,self__.faved_QMARK_,self__.reted_QMARK_,G__6541,self__.id,self__.date,self__.txt,self__.mention_user,self__.source,self__.__meta,self__.__extmap,null));
} else
{if(pred__6544.call(null,"\uFDD0:id",expr__6545))
{return (new grimoire_cloud.twitter.Tweet(self__.user,self__.faved_QMARK_,self__.reted_QMARK_,self__.isret_QMARK_,G__6541,self__.date,self__.txt,self__.mention_user,self__.source,self__.__meta,self__.__extmap,null));
} else
{if(pred__6544.call(null,"\uFDD0:date",expr__6545))
{return (new grimoire_cloud.twitter.Tweet(self__.user,self__.faved_QMARK_,self__.reted_QMARK_,self__.isret_QMARK_,self__.id,G__6541,self__.txt,self__.mention_user,self__.source,self__.__meta,self__.__extmap,null));
} else
{if(pred__6544.call(null,"\uFDD0:txt",expr__6545))
{return (new grimoire_cloud.twitter.Tweet(self__.user,self__.faved_QMARK_,self__.reted_QMARK_,self__.isret_QMARK_,self__.id,self__.date,G__6541,self__.mention_user,self__.source,self__.__meta,self__.__extmap,null));
} else
{if(pred__6544.call(null,"\uFDD0:mention-user",expr__6545))
{return (new grimoire_cloud.twitter.Tweet(self__.user,self__.faved_QMARK_,self__.reted_QMARK_,self__.isret_QMARK_,self__.id,self__.date,self__.txt,G__6541,self__.source,self__.__meta,self__.__extmap,null));
} else
{if(pred__6544.call(null,"\uFDD0:source",expr__6545))
{return (new grimoire_cloud.twitter.Tweet(self__.user,self__.faved_QMARK_,self__.reted_QMARK_,self__.isret_QMARK_,self__.id,self__.date,self__.txt,self__.mention_user,G__6541,self__.__meta,self__.__extmap,null));
} else
{return (new grimoire_cloud.twitter.Tweet(self__.user,self__.faved_QMARK_,self__.reted_QMARK_,self__.isret_QMARK_,self__.id,self__.date,self__.txt,self__.mention_user,self__.source,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__2910__auto__,G__6541),null));
}
}
}
}
...
grimoire_cloud.twitter.Tweet.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__2901__auto__,G__6541){
var self__ = this;
return (new grimoire_cloud.twitter.Tweet(self__.user,self__.faved_QMARK_,self__.reted_QMARK_,self__.isret_QMARK_,self__.id,self__.date,self__.txt,self__.mention_user,self__.source,G__6541,self__.__extmap,self__.__hash));
});
...
grimoire_cloud.twitter.map__GT_Tweet = (function map__GT_Tweet(G__6543){
return (new grimoire_cloud.twitter.Tweet((new cljs.core.Keyword("\uFDD0:user")).call(null,G__6543),(new cljs.core.Keyword("\uFDD0:faved?")).call(null,G__6543),(new cljs.core.Keyword("\uFDD0:reted?")).call(null,G__6543),(new cljs.core.Keyword("\uFDD0:isret?")).call(null,G__6543),(new cljs.core.Keyword("\uFDD0:id")).call(null,G__6543),(new cljs.core.Keyword("\uFDD0:date")).call(null,G__6543),(new cljs.core.Keyword("\uFDD0:txt")).call(null,G__6543),(new cljs.core.Keyword("\uFDD0:mention-user")).call(null,G__6543),(new cljs.core.Keyword("\uFDD0:source")).call(null,G__6543),null,cljs.core.dissoc.call(null,G__6543,"\uFDD0:user","\uFDD0:faved?","\uFDD0:reted?","\uFDD0:isret?","\uFDD0:id","\uFDD0:date","\uFDD0:txt","\uFDD0:mention-user","\uFDD0:source")));
});
