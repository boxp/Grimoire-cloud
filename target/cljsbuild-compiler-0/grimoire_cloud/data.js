...
grimoire_cloud.data.User.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__2904__auto__,k5377,else__2905__auto__){
var self__ = this;
if((k5377 === "\uFDD0:id"))
{return self__.id;
} else
...
{if((k5377 === "\uFDD0:profile-img"))
{return self__.profile_img;
} else
{if((k5377 === "\uFDD0:tweet-count"))
...
{if("\uFDD0:else")
{return cljs.core.get.call(null,self__.__extmap,k5377,else__2905__auto__);
} else
{return null;
}
}
...
grimoire_cloud.data.User.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__2909__auto__,k__2910__auto__,G__5376){
var self__ = this;
var pred__5379 = cljs.core.identical_QMARK_;
var expr__5380 = k__2910__auto__;
if(pred__5379.call(null,"\uFDD0:id",expr__5380))
{return (new grimoire_cloud.data.User(G__5376,self__.name,self__.profile_img,self__.tweet_count,self__.disc,self__.__meta,self__.__extmap,null));
} else
{if(pred__5379.call(null,"\uFDD0:name",expr__5380))
{return (new grimoire_cloud.data.User(self__.id,G__5376,self__.profile_img,self__.tweet_count,self__.disc,self__.__meta,self__.__extmap,null));
} else
{if(pred__5379.call(null,"\uFDD0:profile-img",expr__5380))
{return (new grimoire_cloud.data.User(self__.id,self__.name,G__5376,self__.tweet_count,self__.disc,self__.__meta,self__.__extmap,null));
} else
{if(pred__5379.call(null,"\uFDD0:tweet-count",expr__5380))
{return (new grimoire_cloud.data.User(self__.id,self__.name,self__.profile_img,G__5376,self__.disc,self__.__meta,self__.__extmap,null));
} else
{if(pred__5379.call(null,"\uFDD0:disc",expr__5380))
{return (new grimoire_cloud.data.User(self__.id,self__.name,self__.profile_img,self__.tweet_count,G__5376,self__.__meta,self__.__extmap,null));
} else
{return (new grimoire_cloud.data.User(self__.id,self__.name,self__.profile_img,self__.tweet_count,self__.disc,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__2910__auto__,G__5376),null));
}
}
}
}
...
grimoire_cloud.data.User.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__2901__auto__,G__5376){
var self__ = this;
return (new grimoire_cloud.data.User(self__.id,self__.name,self__.profile_img,self__.tweet_count,self__.disc,G__5376,self__.__extmap,self__.__hash));
});
...
grimoire_cloud.data.map__GT_User = (function map__GT_User(G__5378){
return (new grimoire_cloud.data.User((new cljs.core.Keyword("\uFDD0:id")).call(null,G__5378),(new cljs.core.Keyword("\uFDD0:name")).call(null,G__5378),(new cljs.core.Keyword("\uFDD0:profile-img")).call(null,G__5378),(new cljs.core.Keyword("\uFDD0:tweet-count")).call(null,G__5378),(new cljs.core.Keyword("\uFDD0:disc")).call(null,G__5378),null,cljs.core.dissoc.call(null,G__5378,"\uFDD0:id","\uFDD0:name","\uFDD0:profile-img","\uFDD0:tweet-count","\uFDD0:disc")));
});
...
grimoire_cloud.data.Tweet.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__2904__auto__,k5383,else__2905__auto__){
var self__ = this;
if((k5383 === "\uFDD0:user"))
{return self__.user;
} else
...
{if("\uFDD0:else")
{return cljs.core.get.call(null,self__.__extmap,k5383,else__2905__auto__);
} else
{return null;
}
}
...
grimoire_cloud.data.Tweet.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__2909__auto__,k__2910__auto__,G__5382){
var self__ = this;
var pred__5385 = cljs.core.identical_QMARK_;
var expr__5386 = k__2910__auto__;
if(pred__5385.call(null,"\uFDD0:user",expr__5386))
{return (new grimoire_cloud.data.Tweet(G__5382,self__.faved_QMARK_,self__.reted_QMARK_,self__.isret_QMARK_,self__.id,self__.date,self__.txt,self__.mention_user,self__.source,self__.__meta,self__.__extmap,null));
} else
{if(pred__5385.call(null,"\uFDD0:faved?",expr__5386))
{return (new grimoire_cloud.data.Tweet(self__.user,G__5382,self__.reted_QMARK_,self__.isret_QMARK_,self__.id,self__.date,self__.txt,self__.mention_user,self__.source,self__.__meta,self__.__extmap,null));
} else
{if(pred__5385.call(null,"\uFDD0:reted?",expr__5386))
{return (new grimoire_cloud.data.Tweet(self__.user,self__.faved_QMARK_,G__5382,self__.isret_QMARK_,self__.id,self__.date,self__.txt,self__.mention_user,self__.source,self__.__meta,self__.__extmap,null));
} else
{if(pred__5385.call(null,"\uFDD0:isret?",expr__5386))
{return (new grimoire_cloud.data.Tweet(self__.user,self__.faved_QMARK_,self__.reted_QMARK_,G__5382,self__.id,self__.date,self__.txt,self__.mention_user,self__.source,self__.__meta,self__.__extmap,null));
} else
{if(pred__5385.call(null,"\uFDD0:id",expr__5386))
{return (new grimoire_cloud.data.Tweet(self__.user,self__.faved_QMARK_,self__.reted_QMARK_,self__.isret_QMARK_,G__5382,self__.date,self__.txt,self__.mention_user,self__.source,self__.__meta,self__.__extmap,null));
} else
{if(pred__5385.call(null,"\uFDD0:date",expr__5386))
{return (new grimoire_cloud.data.Tweet(self__.user,self__.faved_QMARK_,self__.reted_QMARK_,self__.isret_QMARK_,self__.id,G__5382,self__.txt,self__.mention_user,self__.source,self__.__meta,self__.__extmap,null));
} else
{if(pred__5385.call(null,"\uFDD0:txt",expr__5386))
{return (new grimoire_cloud.data.Tweet(self__.user,self__.faved_QMARK_,self__.reted_QMARK_,self__.isret_QMARK_,self__.id,self__.date,G__5382,self__.mention_user,self__.source,self__.__meta,self__.__extmap,null));
} else
{if(pred__5385.call(null,"\uFDD0:mention-user",expr__5386))
{return (new grimoire_cloud.data.Tweet(self__.user,self__.faved_QMARK_,self__.reted_QMARK_,self__.isret_QMARK_,self__.id,self__.date,self__.txt,G__5382,self__.source,self__.__meta,self__.__extmap,null));
} else
{if(pred__5385.call(null,"\uFDD0:source",expr__5386))
{return (new grimoire_cloud.data.Tweet(self__.user,self__.faved_QMARK_,self__.reted_QMARK_,self__.isret_QMARK_,self__.id,self__.date,self__.txt,self__.mention_user,G__5382,self__.__meta,self__.__extmap,null));
} else
{return (new grimoire_cloud.data.Tweet(self__.user,self__.faved_QMARK_,self__.reted_QMARK_,self__.isret_QMARK_,self__.id,self__.date,self__.txt,self__.mention_user,self__.source,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__2910__auto__,G__5382),null));
}
}
}
}
...
grimoire_cloud.data.Tweet.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__2901__auto__,G__5382){
var self__ = this;
return (new grimoire_cloud.data.Tweet(self__.user,self__.faved_QMARK_,self__.reted_QMARK_,self__.isret_QMARK_,self__.id,self__.date,self__.txt,self__.mention_user,self__.source,G__5382,self__.__extmap,self__.__hash));
});
...
grimoire_cloud.data.map__GT_Tweet = (function map__GT_Tweet(G__5384){
return (new grimoire_cloud.data.Tweet((new cljs.core.Keyword("\uFDD0:user")).call(null,G__5384),(new cljs.core.Keyword("\uFDD0:faved?")).call(null,G__5384),(new cljs.core.Keyword("\uFDD0:reted?")).call(null,G__5384),(new cljs.core.Keyword("\uFDD0:isret?")).call(null,G__5384),(new cljs.core.Keyword("\uFDD0:id")).call(null,G__5384),(new cljs.core.Keyword("\uFDD0:date")).call(null,G__5384),(new cljs.core.Keyword("\uFDD0:txt")).call(null,G__5384),(new cljs.core.Keyword("\uFDD0:mention-user")).call(null,G__5384),(new cljs.core.Keyword("\uFDD0:source")).call(null,G__5384),null,cljs.core.dissoc.call(null,G__5384,"\uFDD0:user","\uFDD0:faved?","\uFDD0:reted?","\uFDD0:isret?","\uFDD0:id","\uFDD0:date","\uFDD0:txt","\uFDD0:mention-user","\uFDD0:source")));
});
